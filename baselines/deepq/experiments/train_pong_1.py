...
# Xp params
TOTAL_TS = 500000 #500000 #int(1e6) # total nb of steps in the training process
MAX_NB_XPS = 10 # max nb of xps to run
MAX_TS = 10000 # max nb of steps after which we stop learning # must not be used in Pong!
EXPLORE_TS = 1000. 
# Sanity check
