...
# TO MODIFY
TOTAL_TS = 1000 #100000 # 50000 #100000 # total nb of steps in the training process
MAX_NB_XPS = 10 # max nb of xps to run

MAX_TS = 5000 # 10000 #100000 # max nb of steps after which we stop learning
EXPLORE_TS = 500. # 1000. #10000
